...
export class GenerativeAiUseCasesStack extends Stack {
  ...
  constructor(
    ...
    const api = new Api(this, 'API', {
      ...
      tokenUsageTable: database.tokenUsageTable,
      tokenUsageByUsecaseTable: database.tokenUsageByUsecaseTable,
      tokenUsageByModelTable: database.tokenUsageByModelTable,
